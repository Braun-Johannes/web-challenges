...
function printSquare(number) {
  ...
  console.log("The sum for the area is: " + sum);
}
...
function printCircumference(numberC) {
  //   const pi = 3.14159;
  let circle = 2 * Math.PI * numberC;
...
function printRectangleArea(width, length) {
  let recArea = width * length;
  console.log("The areae of the rectangle is " + recArea);
}
